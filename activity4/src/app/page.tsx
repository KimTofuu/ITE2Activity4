...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 md:p-24 bg-black text-white">
      <button
          id="themeToggle"
          onClick={toggleTheme}
          ...
          🌙 Dark Mode
            ...
            <div
                ...
                <br />
                <p>I’m an IT student at Gordon College who loves coding, gaming, and the gym. I got to work as an Assistant Project Manager for a bit, which gave me a taste of the real-world grind. Whether I’m building apps, chasing wins in-game, or pushing reps at the gym, I’m always looking for ways to level up.</p>
            </div>
                        <div className="picture flex flex-col items-center md:items-end justify-center max-w-[340px] min-w-[220px] w-auto m-0 relative flex-1">
                                <Image
                                    className="img w-[180px] h-[180px] md:w-[240px] md:h-[240px] lg:w-[320px] lg:h-[320px] rounded-full object-cover border-[6px] border-white"
                                    src="/assets/pic.jpg"
                                    alt="Profile Picture"
                                    width={320}
                                    height={320}
                                />
                                <span className="handwritten intro absolute text-white opacity-80 pointer-events-none left-[-50px] top-[20px] text-[1rem] -rotate-[18deg] md:left-[-90px] md:top-[60px] md:text-[1.2rem]">
                                    let me<br />introduce<br />myself
                                </span>
                                <span className="handwritten note absolute text-[#bdbdbd] italic opacity-80 pointer-events-none left-[225px] bottom-[60px] text-left text-[0.9rem] max-w-[200px] rotate-[18deg] md:right-[-150px] md:bottom-[10px] md:left-auto md:text-center md:text-[1rem]">
